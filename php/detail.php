...
<body>
    <div class="container">
        ...
        <div class="gambar">
            <img src="../assets/pict/<?= $mapp["Gambar"]; ?>" alt="" width="900" height="600">
        </div>
        <div class="keterangan">
            <table>
                <tr>
                    <th>Kantor : <?= $mapp["Nama"]; ?></th>
                    <th><?= $mapp["Deskripsi"]; ?></th>
        ...
        <a href="lihat.php" class="waves-effect waves-light blue lighten-2 btn small">Kembali</a>
    </div>
</body>
